...
{
    public partial class AdminInvestigatorsManagement : Form
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;
        public AdminInvestigatorsManagement()
        {
            InitializeComponent();
            BindGridView();
        }
        ...
        private void BindGridView()
        {
            ...
            string query = "SELECT UserId, Name, Email, Role, CreatedAt FROM Users WHERE Role = 'Investigator'";
